import registerLoginDemoWebshop from "./pageObject/registerLoginDemoWebshop";
//import loginPage from '/pageObject/registerLoginDemoWebshop';
...
Cypress.Commands.add("RegisterNewAccount", (userFirstName, userLastName, userEmail, userPassword) => {
  ...
  cy.get(loginPage.fillFirstName).clear().  type(userFirstName);
...
//auto Mengetik ntuk membersihkan, mengetik, dan memasukkan nilai
